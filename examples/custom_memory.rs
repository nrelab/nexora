//! Example: Implementing a custom Memory backend for NexOra
//!
...
// ── Re-define the trait types (in your app, import from nexora::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 NexOra Memory Demo — InMemoryBackend\n");
