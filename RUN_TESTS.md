...
```bash
# Check config
cat ~/.nexora/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time nexora channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   nexora daemon
   # or
   RUST_LOG=info nexora channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/nexora/issues
