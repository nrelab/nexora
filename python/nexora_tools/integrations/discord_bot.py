"""
Discord bot integration for NexOra.
"""
...
class DiscordBot:
    """
    Discord bot powered by NexOra agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install nexora-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"NexOra Discord Bot ready: {self.client.user}")
