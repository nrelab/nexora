# Agnostic Security: Nex Impact on Portability
...
# Basic security (always on, nex overhead)
basic-security = []
...
### Conditional Compilation: Nex Overhead When Disabled
...
**Result**: When features are disabled, the code isn't even compiled — **nex binary bloat**.
...
| Hardware | RAM | NexOra (base) | NexOra (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
| **Raspberry Pi Nex** | 512MB | ✅ 2% | ✅ 2.5% | Works |
| **Orange Pi Nex** | 512MB | ✅ 2% | ✅ 2.5% | Works |
| **NanoPi NEO** | 256MB | ✅ 4% | ✅ 5% | Works |
| **C.H.I.P.** | 512MB | ✅ 2% | ✅ 2.5% | Works |
| **Rock64** | 1GB | ✅ 1% | ✅ 1.2% | Works |

**Even with full security, NexOra uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### NexOra's Core Promise: Swap Anything
...
**Result**: Most features add **nex new Rust dependencies** — they either:
