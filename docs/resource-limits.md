# Resource Limits for NexOra

## Problem
NexOra has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for nexora with limits.
