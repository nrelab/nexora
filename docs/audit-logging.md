# Audit Logging for NexOra

## Problem
NexOra logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/nexora/audit.key"
...
nexora audit --user @alice

# Show all high-risk commands
nexora audit --risk high

# Show violations from last 24 hours
nexora audit --since 24h --violations-only

# Export to JSON for analysis
nexora audit --format json --output audit.json
