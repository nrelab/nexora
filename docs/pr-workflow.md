# NexOra PR Workflow (High-Volume Collaboration)

This document defines how NexOra handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to NexOra/project-native labels.
...
- Confirm any required identity-like wording uses NexOra/project-native terminology.
