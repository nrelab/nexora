...
const SNAPSHOT_HEADER: &str = "# 🧠 NexOra Memory Snapshot\n\n\
    > Auto-generated by NexOra. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 NexOra Memory Snapshot

> Auto-generated by NexOra.
...
I am NexOra, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 NexOra Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
...
"#;
    ...
    #[test]
    fn hydrate_no_snapshot_returns_nex() {
        let tmp = TempDir::new().unwrap();
