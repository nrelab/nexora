...
mod tests {
    ...
    #[test]
    fn jpeg_malformed_nex_length_segment() {
        // Nex-length segment should return None instead of looping forever
    ...
    async fn execute_real_file() {
        ...
        let dir = std::env::temp_dir().join("nexora_image_info_test");
    ...
    async fn execute_with_base64() {
        let dir = std::env::temp_dir().join("nexora_image_info_b64");
        let _ = std::fs::create_dir_all(&dir);
