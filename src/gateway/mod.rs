...
pub async fn run_gateway(host: &str, port: u16, config: Config) -> Result<()> {
    ...
    let whatsapp_app_secret: Option<Arc<str>> = std::env::var("NEXORA_WHATSAPP_APP_SECRET")
        .ok()
        .and_then(|secret| {
    ...
    println!("🦀 NexOra Gateway listening on http://{display_addr}");
...
mod tests {
    ...
    #[test]
    fn rate_limiter_nex_limit_always_allows() {
